...
function EditResume() {
  ...
  // Memoize the step change handler
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Form Section */}
            <div className="flex flex-col justify-center mt-10 h-full">
              <div className="flex-1 flex flex-col justify-center h-full min-h-[600px] bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-8">
                <FormSection 
            ...
            <div className="flex flex-col justify-center mt-10 h-full">
              <div className="flex-1 flex flex-col justify-center h-full min-h-[600px] bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-8">
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                  <ResumePreview activeStep={activeStep} />
                </div>
              </div>
            </div>
          </div>
